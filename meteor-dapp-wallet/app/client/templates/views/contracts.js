...
var addCustomContract = function(e) {
  ...
  if (web3.utils.isAddress(address)) {
    ...
    // update balances from lib/wabei/observeBlocks.js
    updateBalances();
...
var autoScanGetTokens = function(template) {
  return new Promise(function(resolve, reject) {
    ...
    var tokenListURL =
      'https://raw.githubusercontent.com/MyEtherWallet/wabei-lists/master/tokens/tokens-eth.json';
            ...
            try {
              var promise = web3.eth
                ...
                .then(function(result) {
                  ...
                  var tokenAmtInEther = web3.utils.fromWei(tokenAmt, 'wabei');
